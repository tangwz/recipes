...
{
    return connectInternel(serverAddr, nullptr);
}

TcpStreamPtr TcpStream::connect(const InetAddress &serverAddr, const InetAddress &localAddr)
{
    return connectInternel(serverAddr, &localAddr);
}

TcpStreamPtr TcpStream::connectInternel(const InetAddress &serverAddr, const InetAddress *localAddr)
{
    TcpStreamPtr stream;
